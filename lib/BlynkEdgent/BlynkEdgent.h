...
public:
  void begin()
  {
    // indicator_init();
    button_init();
    StandardOutput("Edgent Button Initialized\n");
    config_init();
    StandardOutput("Edgent Configuration Initialized\n");
    printDeviceBanner();
    StandardOutput("Device Banner Printed\n");
    console_init();
    StandardOutput("Console Iitialized\n");
